...
invisible(rpc('Page.navigate',list(url=Sys.getenv('BARBAC_STUDIO_URL','http://127.0.0.1:3838'))))
...
nav('cluster');click('publication_preset');caption('02 · Use the publication LV settings','Distance 3, support ordering and the optional Poisson indel model.');hold(4)
