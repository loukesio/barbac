...
using the **minou** palette, one of the 32 LTC palettes included in barbac.
...
`names(barbac_palettes())` to switch colours. No other palette package is
needed. Names such as `"Casa Natal"` and `"casa_natal"` are equivalent.
`barbac_palette("minou", n = 100)` also returns colours for other plots.
