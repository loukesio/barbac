...
<img src="../man/figures/logo.png" align="right" height="120" alt="barbac logo"/>

**barbac** (_**bar**code **b**ioinformatics **a**nalysis and
**c**lustering_) is an R package for end-to-end DNA barcode lineage
...
using the **minou** palette from the
...
`remotes::install_github("loukesio/ltc_palettes")`. Any character
vector of colour hex codes works as `palette`, so
